...
;(function ( $, window, document, undefined ) {
  ...
  $(document).ready(function(){
        $('.cs_font_field').each(function() {
            ...
            var currentVal = jQuery(this).find('.cs-typo-family').val();
            jQuery(this).find("#preview-"+ parentName +"").css("font-family", currentVal);
            $('head').append('<link href="http://fonts.googleapis.com/css?family=' + currentVal +'" class="cs-font-preview-'+ parentName +'" rel="stylesheet" type="text/css" />').load();

            $(this).find('.cs-typo-family').change(function(){
                $('head').find(".cs-font-preview-"+ parentName +"").remove();
                var font = jQuery(this).val();
                $(this).parent().parent().find("#preview-"+ parentName +"").css("font-family", font);
                $('head').append('<link href="http://fonts.googleapis.com/css?family=' + font +'" class="cs-font-preview-'+ parentName +'" rel="stylesheet" type="text/css" />').load();
            });
        });
    });
  // ======================================================
  ...
  $.fn.CSFRAMEWORK_RELOAD_PLUGINS = function() {
    return this.each(function() {
      ...
      $('.cs-field-typography_advanced', this).CSFRAMEWORK_TYPOGRAPHY();
