...
if ($row_type == 'row') {
	...
	$output .= '<div id='. esc_attr($id) .' class="rab-section background_cover row_section ' . esc_attr($css_class_type .' ' . $css_class ).'" ' . (($row_animation != '')? 'data-delay="' . esc_attr($row_animation_delay) . '" data-animation="' . esc_attr($row_animation) . '"' : '') .'>';
    ...
    $output .='<div id='. esc_attr($id) .' class="rab-section parallax sectionOverlay' . ' ' . esc_attr($css_class . ' ' . $el_class .' '. $overlay_texture) .'" ' . (($row_animation != '')? 'data-delay="' . esc_attr($row_animation_delay) . '" data-animation="' . esc_attr($row_animation) . '"' : '') .' data-speed="'. esc_attr($parallax_speed) .'" style = "' . esc_attr($rowspace) . '';
    ...
    $output .='<div id='. esc_attr($id) .' class="rab-section interactive-background' . ' ' . esc_attr($css_class . ' ' . $el_class) .'" ' . (($row_animation != '')? 'data-delay="' . esc_attr($row_animation_delay) . '" data-animation="' . esc_attr($row_animation) . '"' : '') .' style = "';
    ...
    $output .= '<div class="wrap rab-section" style="height:'. esc_attr($video_height) . '; '. esc_attr($rowspace) .'" ' . (($row_animation != '')? 'data-delay="' . esc_attr($row_animation_delay) . '" data-animation="' . esc_attr($row_animation) . '"' : '') .'>';
